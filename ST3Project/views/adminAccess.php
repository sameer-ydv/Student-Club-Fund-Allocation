...
<body>
    <div class="header">
        ...
        <div class="head2"><h1>Welcome Administrator</h1></div>
    </div>
        ...
        <div class="column1">
            <div class="menu-item">
                <ul>
                    ...
                    <li class= ""><a href="#" id="newclubs">New Club Registrations</a></li>
                    <li class= ""><a href="../logout-system/admin_logout.php" style="color: #ff1a1a;">Logout</a></li>
                </ul>
            </div>
        </div>
